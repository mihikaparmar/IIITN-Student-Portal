...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="p3"> Do not have an account? <a href="http://localhost:3000/register">Register Now</a> </div>
                    ...
                    <div className="signup-content">
                        <div className="signup-form">
                            ...
                            <form className="registration-form" id="registration-form">
                                ...
                                <input className='pp33'  type="text" name="password" id="password" 
                                         value={password}
